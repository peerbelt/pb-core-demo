...
ID_RSA=/home/ubuntu/.docker/machines/test-iad-peerbelt-$CIRCLE_BUILD_NUM/id_rsa
...
# Start Papertrail
ssh -i ../.docker/machines/test-iad-peerbelt-$CIRCLE_BUILD_NUM/id_rsa root@`./docker-machine ip`  'sudo chmod 755 /etc/init.d/remote_syslog'
ssh -i ../.docker/machines/test-iad-peerbelt-$CIRCLE_BUILD_NUM/id_rsa root@`./docker-machine ip` 'sudo service remote_syslog start'
